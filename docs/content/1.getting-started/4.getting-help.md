---
description: "How to get help when using `nuxt-prisma` in your Vue / Nuxt 3 application."
---
...
- Search open issues and discussions: https://github.com/sidebase/nuxt-prisma/issues
- Hop on Discord to ask us directly: https://discord.gg/VzABbVsqAc,
- Open an issue to file a bug, ask for an enhancement or get an answer to a question: https://github.com/sidebase/nuxt-prisma/issues/new/choose
